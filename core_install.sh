...
tce-load -iw openssh.tcz ezremaster.tcz nmap.tcz nmap-dbs.tcz tcpdump.tcz python.tcz socat.tcz curl.tcz proxychains-ng.tcz filesystems-5.4.3-tinycore.tcz scsi-5.4.3-tinycore.tcz raid-dm-5.4.3-tinycore.tcz bash.tcz lsscsi.tcz parted.tcz util-linux.tcz   
